    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-[#F97316]/10 via-[#ea384c]/5 to-background">
      ...
      <main className="flex-1 container px-4 py-8 mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-display font-bold mb-2 bg-gradient-to-r from-[#F97316] to-[#ea384c] bg-clip-text text-transparent">
            Analyze Your Food Choices
          </h1>
          
          <div className="flex flex-col items-center gap-2">
            <p className="text-lg md:text-xl italic font-medium text-nalam-earth-dark inline-block py-1 px-6 bg-gradient-to-r from-[#F97316]/30 to-[#ea384c]/30 rounded-full">
              "Eat This Way, Not That Way"
            </p>
            <p className="text-sm text-nalam-earth bg-[#F97316]/10 px-4 py-1 rounded-full inline-block flex items-center justify-center gap-2">
              Know Your Food, Nourish Your World <Heart size={14} className="text-[#ea384c] fill-[#ea384c]" />
            </p>
          </div>
        </div>
        
        <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-lg p-6 mb-8 border border-[#F97316]/30 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-24 h-24 bg-gradient-to-br from-[#F97316]/30 to-[#ea384c]/20 rounded-bl-[100px] -z-0"></div>
          
          <Tabs defaultValue="search" className="w-full relative z-10">
            <TabsList className="w-full mb-6 bg-gradient-to-r from-[#F97316]/20 to-[#ea384c]/20">
        ...
        {isLoading && (
          <div className="max-w-3xl mx-auto text-center py-8">
            <div className="animate-pulse flex flex-col items-center">
              <div className="h-12 w-12 rounded-full bg-gradient-to-r from-[#F97316] to-[#ea384c] mb-4"></div>
