  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute bottom-40 left-1/4 w-40 h-40 rounded-full bg-[#FEC6A1]/20 blur-xl"></div>
        <div className="absolute bottom-60 right-1/4 w-36 h-36 rounded-full bg-[#FFD54F]/10 blur-xl"></div>
      ...
      <main className="flex-1 container px-4 py-8 md:py-12 mx-auto">
        <div className="text-center mb-8 md:mb-12 relative">
          ...
          <div className="flex flex-col items-center gap-3">
            <p className="text-sm text-nalam-earth bg-[#F97316]/10 px-4 py-1.5 rounded-full inline-block flex items-center justify-center gap-2 shadow-sm">
              Know Your Food, Nourish Your World <Heart size={14} className="text-[#ea384c] fill-[#ea384c]" />
            </p>
          </div>
        </div>
        
        <div className="max-w-3xl mx-auto bg-white rounded-3xl shadow-colorful p-6 md:p-8 mb-8 border border-[#F97316]/30 relative overflow-hidden">
