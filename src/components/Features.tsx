    ...
    <section id="features" className="py-20">
      <div className="container px-4 mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-[#F97316] to-[#ea384c]">Smart Features for Smarter Choices</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Card className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-[#F97316]/20">
            <CardHeader>
              <div className="w-12 h-12 bg-[#F97316]/10 rounded-lg flex items-center justify-center mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#F97316]">
              ...
              <CardTitle className="text-[#F97316]">Product Scanning</CardTitle>
              <CardDescription>
            ...
            <CardContent>
              <ul className="space-y-2 text-sm">
                <li className="flex items-start gap-2">
                  <div className="h-5 w-5 rounded-full bg-[#F97316]/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M10 3L4.5 8.5L2 6" stroke="#F97316" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </div>
          ...
          <Card className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-[#F97316]/20">
            <CardHeader>
              <div className="w-12 h-12 bg-[#F97316]/10 rounded-lg flex items-center justify-center mb-4">
                <Egg className="text-[#F97316]" />
              </div>
              <CardTitle className="text-[#F97316]">Food Image Analysis</CardTitle>
              <CardDescription>
          ...
          <Card className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-[#F97316]/20">
            <CardHeader>
              ...
              <CardTitle className="text-[#F97316]">Contextual Suggestions</CardTitle>
              <CardDescription>
          ...
          <Card className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-[#F97316]/20">
            <CardHeader>
              ...
              <CardTitle className="text-[#F97316]">Alternatives Finder</CardTitle>
              <CardDescription>
          ...
          <Card className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-[#F97316]/20">
            <CardHeader>
              ...
              <CardTitle className="text-[#F97316]">Gamification</CardTitle>
              <CardDescription>
          ...
          <Card className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 border border-[#F97316]/20">
            <CardHeader>
              ...
              <CardTitle className="text-[#F97316]">Transparency</CardTitle>
              <CardDescription>
