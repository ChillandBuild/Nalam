      ...
      <div className="container px-4 mx-auto">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
          <div className="w-full md:w-1/2 space-y-6 text-center md:text-left">
            <div className="inline-flex items-center gap-2 bg-white/80 rounded-full py-2 px-4 shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <Button size="lg" className="bg-nalam-green hover:bg-nalam-green-dark text-white">
                Get Early Access
              </Button>
          ...
          <div className="w-full md:w-1/2 relative">
            <div className="aspect-square w-full max-w-md mx-auto relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-nalam-green/30 to-nalam-sky/30 rounded-3xl transform rotate-6 scale-90"></div>
              ...
              <div className="absolute inset-0 rounded-3xl overflow-hidden border-8 border-white shadow-2xl">
                <div className="bg-nalam-green/10 h-full w-full p-4">
                  {/* App mockup content */}
                  <div className="bg-white rounded-lg p-3 mb-4 shadow-sm">
                    <div className="flex items-center gap-3 mb-2">
                      <div className="w-10 h-10 rounded-lg bg-nalam-green flex items-center justify-center">
                    ...
                    <div className="flex justify-between items-center">
                      <div className="eco-badge">Score: 85</div>
                  ...
                  <div className="bg-white rounded-lg p-4 shadow-sm">
                    ...
                    <div className="flex gap-2 overflow-x-auto pb-2">
                      <div className="min-w-[100px] p-2 border rounded-lg text-center">
