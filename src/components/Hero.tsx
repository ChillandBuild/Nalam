        ...
        <div className="mb-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="relative overflow-hidden rounded-2xl shadow-lg group">
            ...
            <div className="absolute bottom-4 left-4 text-white">
              <h3 className="font-semibold text-lg">Fresh & Organic</h3>
              <p className="text-sm opacity-90">Sustainable food choices</p>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-2xl shadow-lg group">
            <img 
              ...
              alt="Healthy meal bowl with vegetables"
              className="w-full h-48 object-cover transition-transform duration-300 group-hover:scale-110"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
            <div className="absolute bottom-4 left-4 text-white">
              <h3 className="font-semibold text-lg">Nutritious Meals</h3>
              <p className="text-sm opacity-90">Balanced nutrition daily</p>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-2xl shadow-lg group">
            <img 
              ...
              alt="Green smoothie and healthy ingredients"
              className="w-full h-48 object-cover transition-transform duration-300 group-hover:scale-110"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent"></div>
            <div className="absolute bottom-4 left-4 text-white">
              <h3 className="font-semibold text-lg">Natural Energy</h3>
              <p className="text-sm opacity-90">Plant-based wellness</p>
            </div>
          </div>
        </div>
          ...
          <div className="w-full md:w-1/2 relative">
            ...
            <div className="mb-6 relative overflow-hidden rounded-2xl shadow-xl">
              <img 
                ...
                alt="Fresh salad with mixed vegetables"
                className="w-full h-64 object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#F97316]/20 to-transparent"></div>
              <div className="absolute bottom-4 left-4 text-white">
                <h3 className="font-semibold text-xl">Healthy Living</h3>
                <p className="text-sm opacity-90">Track your nutrition journey</p>
              </div>
            </div>

            {/* Mock Data Display */}
            <div className="mt-6 md:mt-0">
              {/* ... keep existing code (Card component with popular food analysis) the same ... */}
              <Card className="overflow-hidden border-none shadow-xl rounded-[2rem] bg-gradient-to-br from-white to-[#FFF7ED] group">
                ...
                <CardContent className="p-6 relative z-10">
                  ...
                  {/* Quick Search and Fact of the Day */}
