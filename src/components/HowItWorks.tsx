    ...
    <section id="how-it-works" className="py-20 bg-[#F97316]/5">
      <div className="container px-4 mx-auto">
        ...
        <div className="relative">
          ...
          <div className="hidden md:block absolute top-24 left-1/2 h-[calc(100%-130px)] w-1 bg-[#F97316]/20 -translate-x-1/2 rounded-full z-0"></div>
          ...
          <div className="space-y-16 relative z-10">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
              <div className="md:w-1/2 flex justify-end order-1 md:order-none">
                <div className="bg-white rounded-xl shadow-lg p-6 max-w-md">
                  ...
                  <div className="bg-[#F97316]/5 p-4 rounded-lg">
                    <div className="flex items-center gap-2 text-sm">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#F97316]">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
              <div className="md:w-1/2 md:pr-12 flex justify-center md:justify-end order-1 md:order-1">
                <div className="w-24 h-24 rounded-full bg-[#ea384c] flex items-center justify-center shadow-lg">
                  <Apple size={40} className="text-white" />
                </div>
              </div>
              <div className="md:w-1/2 flex justify-center md:justify-start order-2">
                <div className="bg-white rounded-xl shadow-lg p-6 max-w-md">
                  <div className="w-12 h-12 bg-[#ea384c] rounded-full flex items-center justify-center text-white font-bold mb-4">2</div>
                  ...
                  <div className="bg-[#ea384c]/5 p-4 rounded-lg">
                    <div className="flex items-center gap-2 text-sm">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[#ea384c]">
                        <path d="M8 1V15" stroke="currentColor" strokeWidth="2" strokeLinecap="round"></path>
                        <path d="M1 8H15" stroke="currentColor" strokeWidth="2" strokeLinecap="round"></path>
                      </svg>
                      <span className="font-medium text-foreground">Pro Tip:</span>
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
              <div className="md:w-1/2 flex justify-end order-1 md:order-none">
                <div className="bg-white rounded-xl shadow-lg p-6 max-w-md">
                  <div className="w-12 h-12 bg-[#F97316] rounded-full flex items-center justify-center text-white font-bold mb-4">3</div>
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
              ...
              <div className="md:w-1/2 flex justify-center md:justify-start order-2">
                <div className="bg-white rounded-xl shadow-lg p-6 max-w-md">
                  <div className="w-12 h-12 bg-[#ea384c] rounded-full flex items-center justify-center text-white font-bold mb-4">4</div>
