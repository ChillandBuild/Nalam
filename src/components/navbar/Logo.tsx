  ...
  return (
    ...
    >
      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#F97316] to-[#ea384c] flex items-center justify-center shadow-lg group-hover:shadow-[#F97316]/30 transition-all duration-300">
        <Heart className="w-5 h-5 text-white fill-[#fff] animate-pulse-orange-red" />
      </div>
      <div className="flex flex-col">
        <h1 className="font-tangerine text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#F97316] to-[#ea384c]">Nalam</h1>
